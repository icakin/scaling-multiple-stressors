...
# Runtime: steps 01-04, 08, 11 and 15 are quick. Steps that fit Stan models
# are expensive, although each caches its fits in results/rds/ and reloads
# them on rerun (delete a cached .rds to force that refit):
